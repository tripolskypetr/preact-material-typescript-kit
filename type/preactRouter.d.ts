declare namespace preact {
    export interface Attributes extends preactRouter.RoutableProps {}
}
...
declare namespace preactRouter {
    ...
    export function Link(props: {activeClassName?: string} & JSXInternal.HTMLAttributes): preact.VNode;
